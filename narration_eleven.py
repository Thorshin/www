...
# Générer l'audio avec une voix masculine (par exemple Josh)
...
# Sauvegarder en MP3
with open("narration_masculine.mp3", "wb") as f:
    f.write(audio)

print("✅ Audio généré avec succès : narration_masculine.mp3")
