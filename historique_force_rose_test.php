...
$entite_filter = isset($_GET['entite']) ? $_GET['entite'] : '';
...
if (isset($_GET['export']) && $_GET['export'] === 'csv') {
    ...
    fputcsv($output, ['Date', 'Nom', 'Site', 'Entité', 'Concerné', 'Nature', 'Anomalie', 'Photo',  'Observation', 'Critique'], ';');
...
') {
    ...
    $headers = ['Date', 'Nom', 'Site', 'Entité', 'Service', 'Concerné', 'Nature', 'Anomalie', 'Observation', 'Critique'];
    $widths = [23, 23, 23, 23, 23, 23, 23, 67, 23, 23, 23];
...
@media (max-width: 768px) {
  /* Garder uniquement colonnes : 1 = Date, 4 = Entité, 8 = Anomalie, 9 = Photo */
  td:not(:nth-child(1)):not(:nth-child(4)):not(:nth-child(8)):not(:nth-child(9)),
  th:not(:nth-child(1)):not(:nth-child(4)):not(:nth-child(8)):not(:nth-child(9)) {
    display: none;
  }
...
<div class="ms-3" style="font-size: 0.5rem; line-height: 1.1; font-weight: 500; color: #333;">
...
<h1 class="fw-bold text-primary" style="text-align: center; font-size: 0.9rem; margin-bottom: 0.5rem;">
  ...
  <form class="row g-3 mb-4" method="get">
    <div class="col-md-2">
      ...
      <input type="date" name="date_debut" value="<?php echo htmlspecialchars($debut); ?>" class="form-control">
    </div>
    <div class="col-md-2">
      <label class="form-label">Date fin</label>
      <input type="date" name="date_fin" value="<?php echo htmlspecialchars($fin); ?>" class="form-control">
    </div>
    <div class="col-md-2">
      <label class="form-label">Service concerné</label>
      <select name="service_concerne" class="form-select">
    ...
    <div class="col-md-2">
      ...
      <input type="text" name="site" value="<?php echo htmlspecialchars($site_filter); ?>" class="form-control">
    </div>
    <div class="col-md-2">
      <label class="form-label">Entité</label>
      <input type="text" name="entite" value="<?php echo htmlspecialchars($entite_filter); ?>" class="form-control">
    </div>
    <div class="col-md-2">
      <label class="form-label">Recherche</label>
      <input type="text" name="recherche" value="<?php echo htmlspecialchars($recherche); ?>" class="form-control" placeholder="Texte libre...">
    </div>
...
<div class="export-buttons">
  ...
  <div>
    <a href="formulaire.php" class="btn btn-secondary">↩ Retour</a>
  </div>
</div>
