...
<div class="ligne-critique-container">
  <select name="nature" class="form-select" required>
    ...
    <option value="Signalisation et balisage">Signalisation et balisage</option>
    <option value="Produits auxiliaires">Produits auxiliaires</option>
    <option value="Etat des pistes">Etat des pistes</option>
    <option value="Environnement">Environnement</option>
    <option value="Armoire électrique">Armoire électrique</option>
    <option value="Circulation">Circulation</option>
    <option value="Chargement , dechargement et stock">Chargement , dechargement et stock</option>
