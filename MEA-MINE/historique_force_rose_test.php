...
@media (max-width: 768px) {
  /* Garder uniquement colonnes : 1 = Date, 3 = Site, 7 = Anomalie, 9 = Photo */
  td:not(:nth-child(1)):not(:nth-child(3)):not(:nth-child(7)):not(:nth-child(9)),
  th:not(:nth-child(1)):not(:nth-child(3)):not(:nth-child(7)):not(:nth-child(9)) {
    display: none;
  }
