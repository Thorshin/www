...
<div class="ligne-critique-container">
  <select name="nature" class="form-select" required>
    <option value="Absence ou obsolescence des plans d’évacuation">Absence ou obsolescence des plans d’évacuation</option>
    <option value="Boîtiers électriques ouverts">Boîtiers électriques ouverts</option>
    <option value="Caillebotis et moyen d’accès">Caillebotis et moyen d’accès</option>
    <option value="Chemins de câbles mal fixés ou obstrués">Chemins de câbles mal fixés ou obstrués</option>
    <option value="Corrosion">Corrosion</option>
    <option value="Déchets ou matériaux mal stockés">Déchets ou matériaux mal stockés</option>
    ...
    <option value="Extincteurs non vérifiés ou absents">Extincteurs non vérifiés ou absents</option>
    <option value="Fuite de produit">Fuite de produit</option>
    <option value="Fuite d'huile">Fuite d'huile</option>
    <option value="Housekeeping et hygiène">Housekeeping et hygiène</option>
    <option value="Infiltration d’eau">Infiltration d’eau</option>
    <option value="Mise à la terre absente ou non conforme">Mise à la terre absente ou non conforme</option>
    ...
    <option value="Présence de zones ATEX mal identifiées ou non conformes">Présence de zones ATEX mal identifiées ou non conformes</option>
    <option value="Supports de tuyauterie détériorés ou déplacés">Supports de tuyauterie détériorés ou déplacés</option>
    <option value="Equipement difficiles à manœuvrer">Equipement difficiles à manœuvrer</option>
